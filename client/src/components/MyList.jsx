...
export function MyList({ studentId, saved, profile, onOpen, onRemove, onClearAll }) {
  ...
  return (
    <div className="stack">
      ...
      {sub === "list"
        ? <SavedList studentId={studentId} saved={saved} onOpen={onOpen} onRemove={onRemove} onClearAll={onClearAll} />
